...
<div role="main" class="container">
  <main class="row">
    <article class="col-lg-6">
      ...
      <div class="w-100">
        <img src="<?php echo $bancoDC[$personagem]['caminho']; ?>" class="img-personagens img-bordas"
          alt="<?php echo $bancoDC[$personagem]['alt']; ?>">
      ...
      <div class="row bg-light img-bordas mb-2">
        ...
        <div class="col-6 mb-2 mt-2">
          <a href="<?php $_SERVER['PHP_SELF']; ?>?personagem=<?php echo $bancoDC[$key]['key']; ?>"
            aria-label="Link para da página a hq <?php echo $bancoDC[$key]['nome']; ?>">
            <img src="<?php echo $bancoDC[$key]['caminho']; ?>" class="w-100 img-bordas"
              alt="<?php echo $bancoDC[$key]['alt']; ?>">
          </a>
        </div>
        <?php
                    }
