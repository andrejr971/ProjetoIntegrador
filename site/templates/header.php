...
<head>
  ...
  <?php if (verificaCss()) { ?>
  <link rel="stylesheet"
    href="<?php echo !$resultado ? "" : "../../"; ?>autores/<?php echo verificaCss() ?>/css/style.css">
  <?php } ?>
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav ml-auto">
          <li class="nav-item"><a href="<?php echo !$resultado ? "" : "../../"; ?>index.php" class="nav-link">Home</a>
          </li>
          <li class="dropdown menu-large nav-item">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"
              aria-label="Menu dropdown Categoria">Categorias</a>
            <ul class="dropdown-menu megamenu">
              <li class="dropdown-item">
                <div class="row">
                  <div class="col-6 col-md-4 col-lg-2 text-center mb-2">
                    <a href="<?php echo !$resultado ? "" : "../../"; ?>autores/caio/index.php">
                      <img class="img-fluid" src="<?php echo !$resultado ? "" : "../../"; ?>img/bg_ficcao.jpg"
                        alt="Logotipo Ficção Científica - Menu">
          ...
          <li class="nav-item"><a href="<?php echo !$resultado ? "" : "../../"; ?>contato.php"
              class="nav-link">Contato</a></li>
          <li class="nav-item"><a href="<?php echo !$resultado ? "" : "../../"; ?>quem-somos.php" class="nav-link">Quem
              Somos</a></li>
        </ul>
      </div>
    </div>
