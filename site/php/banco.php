...
$bancoDC = [
    ...
    'Batman1' =>[
        ...
        'caminho' => 'img/bat1.jpg',
        'desc' => 'Com a publicação de SILÊNCIO, as aventuras da revista mensal do Cavaleiro das Trevas foram revigoradas por dois dos maiores talentos criativos da indústria dos quadrinhos: JEPH LOEB e JIM LEE. JEPH LOEB é o autor de inúmeros sucessos, como Batman: o Longo Dia das Bruxas, Superman: As Quatro Estações, Batman: Vitória Sombria, Homem-Aranha: Azul, Mulher-Gato: Cidade Eterna, entre outros. JIM LEE é o aclamado desenhista que revolucionou a indústria dos quadrinhos nos anos noventa, quando foi o responsável pelo estouro de vendas da revista X-Men e, posteriormente, quando se tornou um dos fundadores da Image Comics. Juntos, eles criaram uma história de proporções épicas envolvendo amizade, confiança e traição ao longo de doze capítulos que ficarão marcados na história do personagem. São estas aventuras que a Panini Books reuniu em um volume de 340 PÁGINAS, contendo os doze capítulos da saga e mais dezenas de esboços do fenômeno Jim Lee, comentários dos criadores e galeria de capas, reunindo tudo em uma edição verdadeiramente DEFINITIVA, com toda a dedicação e cuidado que este material de colecionador merece.',
        'alt' => 'Capa da HQ Batman Silêncio',
        'personagem' => 'Batman',
        'escritor' => 'Loeb,Jeph, Lee,Jim, WILLIAMS,SCOTT',
        'key' => 'Batman1'
    ],
    'Batman2' =>[
        'nome' => 'Batman - Fim de Jogo',
        'caminho' => 'img/bat2.jpg',
        'desc' => 'GOTHAM CITY ESTÁ RUINDO… O JOGO ACABOU. O maior inimigo do Batman está de volta. Mas, desta vez, nem mesmo o Coringa está rindo. No último encontro entre eles, o Cavaleiro das Trevas não esteve à altura dos grandiosos planos do Palhaço do Crime, então agora o vilão não está mais para brincadeiras. Os jogos acabaram. Todas as cartas estão na mesa. E no confronto mais intenso já visto entre eles, nada mais será sagrado para o Coringa: a família do Homem-Morcego, seus amigos e aliados, sua casa… ninguém está a salvo. O Palhaço do Crime não está mais interessado em uma comédia, somente em uma grande e terrível tragédia. A equipe campeã de vendas do New York Times formada por SCOTT SNYDER (Vampiro Americano) e GREG CAPULLO (Spawn) criam o confronto definitivo entre o maior herói de Gotham e vilão mais sinistro dos quadrinhos.',
        'alt' => 'Capa da HQ Batman - Fim de Jogo',
        'personagem' => 'Batman',
        'escritor' => 'Snyder,Scott',
        'key' => 'Batman2'
    ],
    'MulherMaravilha0' =>[
        'nome' => 'Mulher Maravilha - Sangue',
        'caminho' => 'img/ww0.jpg',
        'desc' => 'Sasuke, agora um criminoso procurado pela Vila da Folha, procura realizar sua vingança contra Danzou e se infiltra no local da reunião dos cinco Kages. E chega a hora de os outros líderes darem uma amostra das incríveis capacidades que os alçaram ao posto supremo de suas vilas! Madara, em uma cartada ousada, conta a todos o seu plano megalomaníaco e faz uma declaração bombástica!',
        'alt' => 'Capa da HQ Mulher Maravilha - Sangue',
        'personagem' => 'Mulher Maravilha',
        'escritor' => 'Azzarello,Brian, Chiang,Cliff, Akins,Tony',
        'key' => 'MulherMaravilha0'
    ],
    'MulherMaravilha1' =>[
        'nome' => 'Lendas do Universo DC: Mulher Maravilha - Volume 1',
        'caminho' => 'img/ww1.jpg',
        'desc' => 'Em 1987, a Crise das Infinitas Terras havia revolucionado o Universo DC. Sem saber muito bem como apresentar sua maior heroína a uma nova geração de leitores, a Editora da Lendas passou a relutantemente considerar a ideia do roteirista Greg Potter de aproximar a personagem de elementos da mitologia grega. No entanto, somente quando o respeitado e megapopular George Pérez adotou o projeto foi que a editora acabou dando seu aval para o que veio a se provar, logo nas primeiras edições, um clássico instantâneo dos comics!',
        'alt' => 'Capa da HQ Mulher Maravilha - Lendas do Universo DC',
        'personagem' => 'Mulher Maravilha',
        'escritor' => 'Perez, George',
        'key' => 'MulherMaravilha1'
    ],
    'MulherMaravilha2' =>[
        'nome' => 'Mulher Maravilha - Guerra',
        'caminho' => 'img/ww2.jpg',
        'desc' => 'Quando se é herdeiro do Olimpo, uma briga de família pode significar o fim de tudo o que existe. Zeus, o pai da Mulher-Maravilha, desapareceu. Sua família – tias e tios, irmãs e irmãos, deuses e semideuses – agora são um instável panteão formado por alguns dos seres mais poderosos do universo, todos eles dispostos a guerrear para assumir o trono de seu antigo líder. Mais que isso, os olimpianos não hesitarão em destruir qualquer um que fique em seu caminho, incluindo o filho ainda bebê de Zeus — uma criança que pode conter um poder capaz de dar início ao apocalipse! E enquanto a Mulher-Maravilha e seus poucos amigos remanescentes lutam para proteger a vida do filho mais jovem do Olimpo, o mais velho deles ressurge. Conhecido apenas como “O Primogênito”, esse ser passou praticamente a vida inteira exilado, e seu poder e sua crueldade apenas cresceram nesses milênios. Agora, ele pretende incinerar a Terra e o Olimpo, mesmo que isso faça dele o rei de um mundo de cinzas.',
        'alt' => 'Capa da HQ Mulher Maravilha - Guerra',
        'personagem' => 'Mulher Maravilha',
        'escritor' => 'Azzarello, Brian',
        'key' => 'MulherMaravilha2'
    ],
    'Superman0' =>[
    ...
    'Superman2' =>[
        ...
        'caminho' => 'img/super1.jpg',
        'desc' => 'O Superman se tornou um monstro como o Apocalypse e representa uma ameaça para todo o planeta Terra! Mas, mesmo assim, precisa dar um jeito de enfrentar Brainiac e seu insano plano que colocar em risco a vida dos seres humanos. Batman, Mulher-Maravilha, Aço, Supergirl, Cyborg, Caçador de Marte, Lois Lane e até o Capuz Vermelho têm papéis a cumprir nessa insana e descomunal batalha. Agora, cabe a cada um fazer o seu melhor (ou o pior!)',
        'alt' => 'Capa da HQ Superman Condenado - Volume 2',
        'personagem' => 'Superman',
        'escritor' => 'Siegel, Jerry',
        'key' => 'Superman2'
    ],
    'Outros0' => [
        ...
        'personagem' => 'Outros',
        'escritor' => 'Orlando, Steve',
        'key' => 'Outros0'
    ],
    'Outros1' => [
        'nome' => 'Flash - Seguindo em Frente - Volume 1',
    ...
    'Outros2' => [
        ...
        'caminho' => 'img/out2.jpg',
        'desc' => 'SHAZAM! Com essas duas simples sílabas, um jovem perdido, mas de coração puro, se transforma no Mortal Mais Poderoso da Terra e usa seus tremendos poderes para salvar os inocentes. Essa é a história que você conhece… e essa é a história que vai ser revolucionada agora! Pelas mãos de dois criadores consagrados, um dos maiores ícones das histórias em quadrinhos volta ao Universo DC em uma nova roupagem, mas ainda carregando todas as características que o transformaram em uma lendária figura da cultura mundial. E, junto com ele, toda a sua carismática galeria de aliados e terríveis inimigos!',
