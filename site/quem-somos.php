                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card mt-2 mb-3">
                                ...
                                <div class="avatar mx-auto">
                                    <img src="img/andre.jpg" alt="André">
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card mt-2 mb-3">
                                <div class="card-fundo"></div>
                                <div class="avatar mx-auto">
                                    <img src="img/carol.jpg" alt="Caroline">
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card mt-2 mb-3">
                                <div class="card-fundo"></div>
                                <div class="avatar mx-auto">
                                    <img src="img/henrique.jpg" alt="Henrique">
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card mt-2 mb-3">
                                <div class="card-fundo"></div>
                                <div class="avatar mx-auto">
                                    <img src="img/vinicius.jpg" alt="Vinicius">
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card mt-2 mb-3">
                                <div class="card-fundo"></div>
                                <div class="avatar mx-auto">
                                    <img src="img/wagner.jpg" alt="Wagner">
                                </div>
                                <div class="card-body">
