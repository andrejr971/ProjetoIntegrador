...
<div class="container">
  <header>
    <div class="row">
      <div class="col">
        <a href="#" data-toggle="modal" data-target="#noticia" role="dialog" aria-label="Abrir modal">
          <img src="img/home/slide1.jpg" class="d-block w-100 img-bordas" alt="Imagem Chiaroscuro">
          <h2 class="titulo1">Novo yearbook da Chiaroscuro Studios abordará os super-heróis
            brasileiros</h2>
        </a>
      </div>
        ...
        <div class="row">
          <div class="col">
            <a href="#" class="link-slide" data-toggle="modal" data-target="#new1"
              ...
              <div class="row">
                <div class="col-4">
                  <img src="autores/andre/img/new0.jpg" class="d-block w-100 img-bordas"
                    alt="Imagem do filme esquadrão suicida">
                </div>
                <div class="col">
                  <h2 class="titulo2-news">Esquadrão Suicida | James Gunn revela foto do roteiro e indica trilha sonora
                  </h2>
                </div>
              </div>
            </a>
        ...
        <div class="row">
          <div class="col">
            <a href="#" class="link-slide" data-toggle="modal" data-target="#new3"
              ...
              <div class="row">
                <div class="col-4">
                  <img src="autores/andre/img/new2.jpg" class="d-block w-100 img-bordas"
                    alt="Imagem do cabaleiro das trevas - Batman">
                </div>
                <div class="col">
  ...
  <main class="row">
    <article class="col-12 col-sm-12 col-md-12 col-lg-8">
      <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="populares" data-toggle="tab" href="#popu" role="tab" aria-controls="populares"
            aria-selected="true">Populares</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="recomendados" data-toggle="tab" href="#rec" role="tab" aria-controls="recomendados"
            aria-selected="false">Recomendações</a>
        </li>
      </ul>
          ...
          <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-6 mb-1 mt-1">
              <a href="<?php echo $bancoHome[$id]['end']; ?>"
                aria-label="para a página da hq <?php echo $bancoHome[$id]['nome']; ?>">
                <div class="row">
                  <div class="col-sm-6">
                    <img src="<?php echo $bancoHome[$id]['caminho']; ?>" class="d-block w-100 img-bordas"
                      alt="<?php echo $bancoHome[$id]['alt']; ?>">
                  </div>
                  <div class="col-sm-6">
          ...
          <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-6 mb-1 mt-1">
              <a href="<?php echo $bancoHome[$contador]['end']; ?>">
                <div class="row">
                  <div class="col-sm-6">
                    <img src="<?php echo $bancoHome[$contador]['caminho']; ?>" class="d-block w-100 img-bordas"
                      alt="<?php echo $bancoHome[$id]['alt']; ?>">
                  </div>
                  <div class="col-sm-6">
    ...
    <aside class="col-sm-12 col-md-12 col-lg-4" aria-label="Últimos Reviews">
          ...
          <a href="#" class="link-slide" data-toggle="modal" data-target="#new2"
            ...
            <div class="row m-1">
              <div class="col-12 col-sm-6 col-md-6">
                <img src="autores/andre/img/new1.jpg" class="d-block w-100 img-bordas"
                  alt="Imagem da amazona mulher maravilha">
              </div>
              <div class="col">
        ...
        <div class="col">
          <a href="#" class="link-slide" data-toggle="modal" data-target="#new1"
            ...
            <div class="row m-1">
              <div class="col-12 col-sm-6 col-md-6">
                <img src="autores/andre/img/new0.jpg" class="d-block w-100 img-bordas"
                  alt="Imagem do filme do Esquadrão Suicida">
              </div>
              <div class="col">
                <h3 class="titulo2-news">Esquadrão Suicida | James Gunn revela foto do roteiro e indica trilha sonora
                </h3>
              </div>
            </div>
          </a>
      ...
      <div class="row m-1">
        <div class="col">
          <a href="#" class="link-slide" data-toggle="modal" data-target="#new3"
            aria-label="Abrir modal: notícia Descoberto o possível novo Batman da DC Comic">
            <div class="row m-1">
              <div class="col-12 col-sm-6 col-md-6">
                <img src="autores/andre/img/new2.jpg" class="d-block w-100 img-bordas"
                  alt="Imagem do cabaleiro das trevas - Batman">
  ...
  <section class="news" aria-label="Seção de últimos artigos  ">
    <div class="w-100">
      <hr>
    </div>
    ...
    <div class="row m-1">
      <div class="col-sm-6">
        <div class="row m-1">
          <div class="col-md-12 col-lg-6">
            <a href="autores/wagner/manga.php?manga=kimetsu" aria-label="para a página do manga Kimetsu no yiaba">
              <img src="autores/wagner/img/kimetsu2.jpg" class="d-block w-100 img-bordas"
                alt="Capa do Kimersu no yaiba">
            </a>
          </div>
          <div class="col">
            <a href="autores/wagner/manga.php?manga=kimetsu" aria-label="para a página do manga Kimetsu no yiaba">
            ...
            <article>
              <p class="text-justify">Com o fim da primeira temporada de Demon Slayer (Kimetsu no Yaiba), muitos fãs
                procuraram o mangá pra saber o que irá acontecer na história, mas outros preferem esperar por novos
                episódios do anime...</p>
            </article>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="row m-1">
          <div class="col-md-12 col-lg-6">
            <a href="autores/wagner/manga.php?manga=boku" aria-label="para a página do manga Boku no Hero Academy">
          ...
          <div class="col">
            ...
            <p class="text-justify">A informação surgiu já que foram revelados os títulos dos próximos episódios da
              quarta temporada da adaptação para série anime Boku no Hero Academia, de Kohei Horikoshi, e com eles veio
              a informação de que o 4ª episódio não será...</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row m-1">
          <div class="col-md-12 col-lg-6">
            <a href="autores/henrique/personagens.php?persona=wolverine"
              aria-label="para a página do anti-héroi Wolverine">
          ...
          <div class="col">
            ...
            <p class="text-justify">foi revelado que ele nasceu no Canadá com poderes mutantes no século 19, com garras
              de ossos que saltam de suas mãos e um elevado fator de cura que o permite sobreviver aos piores ferimentos
              e faz com que envelheça lentamente. Batizado de James Howlett...</p>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="row m-1">
          <div class="col-md-12 col-lg-6">
            <a href="autores/henrique/personagens.php?persona=mulher_gato"
              aria-label="para a página da anti-héroi Mulher Gato">
          ...
          <div class="col">
            ...
            <p class="text-justify">Sua mãe, Maria Kyle, era dada à putaria e à agressividade, batia nela e na sua irmã
              mais nova, Magdalena, quando eram pequenas. Não satisfeita pela porrada que dava às duas garotas...</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <article>
          <p class="text-justify">Os yearbooks da Chiaroscuro Studios já está se tornando uma tradição ao final de cada
            ano.</p>
          <p class="text-justify">Desde 2016, uma nova edição é lançada apresentando os talentos dos artistas agenciados
            pelo estúdio, e passou a ser temático. Em 2017, foi uma graphic novel chamada Dias de Horror e, em 2018, um
            especial sobre lendas brasileiras. Agora, em 2019 abordar os super-heróis brasileiros.</p>
          <p class="text-justify">Grande Almanaque dos Super-heróis Brasileiros (formato 21 cm x 31 cm, 140 páginas,
            capa
            dura) será uma enciclopédia com mais de 200 heróis dos quadrinhos brasileiros reimaginados pelos
            quadrinhistas
            do estúdio.</p>
          <p class="text-justify">O projeto já está disponível para apoios no Catarse em diferentes planos e diversas
            recompensas, que vão desde autógrafos até sketches de artistas e entradas na CCXP, onde ocorrerá o
            lançamento
            do livro.</p>
          <p class="text-justify">Além de novos designs criados pelos artistas da Chiaroscuro Studios para 57 desses
            super-heróis, a edição trará verbetes explicativos com informações sobre os personagens e seus criadores.
          </p>
          <p class="text-justify">Os textos e a pesquisa são do editor Franco de Rosa.</p>
          <p class="text-justify">Os artistas participantes são Adriana Melo, Adriano Augusto, Adriano Di Benedetto,
            Alex
            Lins, Alex Shibao, Alisson Borges, Allan Jeff, Andrei Bressan, Anthony Marques, Breno Tamura, Bruno
            Oliveira,
            Cris Bolson, Cris Peter, Daniel HDR, Daniel Maia, Danilo Beyruth, Dijjo Lima, Diogenes Neves, Douglas
            Franchin, Eber Ferreira, Eddy Barrows, Eduardo Pansica, Elton Thomasi, Felipe Watanabe, Giovanni Valletta,
            Ig
            Guara, Ivan Reis, Joe Prado, Jonas Trindade, José Luis, Julio Brilha, Julio Ferreira, Leonardo Romero, Lucas
            Werneck, Marcelo Costa, Marcelo Di Chiara, Marcelo Maiolo, Marcio Fiorito, Marcio Hum, Marcio Menyz, Marcio
            Takara, Mauro Fodra, Mike Deodato, Natália Marques, Nuno Plati, Oclair Albert, Oren Junior, Paulo Siqueira,
            Péricles Júnior, RB Silva, Ricardo Jaime, Robson Rocha, Rod San, Rodney Buchemi, Rodrigo Spiga, Rogê
            Antônio,
            Ronan Cliquet, Ronilson Freire, Ruy José, Thony Silas, Wilton Santos, Yildiray Çinar e Zé Carlos.</p>
          <p class="text-justify"><strong>Referência</strong></p>
          <p class="text-justify"><a
              href="http://www.universohq.com/noticias/novo-yearbook-da-chiaroscuro-studios-abordara-os-super-herois-brasileiros/"
              target="_blank">
